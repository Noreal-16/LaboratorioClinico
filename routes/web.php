...
Route::middleware(['auth:sanctum', 'verified'])->get('laboratorios/llamaData', [LaboratorioController::class, 'getDatosLaboratorio1'])->name('laboratorios.getDatosLaboratorio1');
/**
...
Route::middleware(['auth:sanctum', 'verified'])->get('categorias/llenaData', [CategoriaController::class, 'getDatosCategoria1'])->name('categorias.getDatosCategoria1');
...
Route::middleware(['auth:sanctum', 'verified'])->get('examenes/show/{id}', [ExamenController::class, 'show'])->name('examenes.show');
Route::middleware(['auth:sanctum', 'verified'])->post('examenes/actualizar', [ExamenController::class, 'update'])->name('examenes.update');
